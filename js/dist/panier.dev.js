...
function createArticles() {
  ...
  summary.insertAdjacentHTML("beforeend", "<div id=\"cmdSummary\" class=\"main-color my-3 border border-dark px-3\">\n      <h5>Votre commande comprend :</h5>\n      <ul>\n        <li class=\"fs-3\">".concat(getPanier.length, " articles</li>\n        <li class=\"fs-3\"> Pour un prix total de : ").concat(JSON.parse(getPanier[getTotalPanier.length]).price, "\u20AC></li>\n      </ul>\n      </div>\n      "));
